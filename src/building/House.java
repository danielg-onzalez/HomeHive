...
public class House {
    ...
    private double calculateHouseSquareFeet(){
        ...
        double kitchenSquareFeet = (kitchen.getLength() * kitchen.getWidth());
        double livingRoomSquareFeet = (livingRoom.getLength() * livingRoom.getWidth());
        double bedroomSquareFeet = (bedroom.getLength() * bedroom.getWidth());
        double bathroomSquareFeet = (bathroom.getLength() * bathroom.getWidth());
        totalSquareFeet  = (kitchenSquareFeet + livingRoomSquareFeet + bedroomSquareFeet + bathroomSquareFeet);
